    ...
    const installFloor = () => {
        ...
        flats.forEach(flat => {
           if(flat.classList.contains('booking')) {
            flat.querySelector('.status-cell_text-span').innerHTML = "Бронь"
           } else if(flat.classList.contains('action')){
            flat.querySelector('.status-cell_text-span').innerHTML = "Акция"
           } else if(flat.classList.contains('sold')){
            flat.querySelector('.status-cell_text-span').innerHTML = "Продано"
           } else {
            flat.querySelector('.status-cell_text-span').innerHTML = "Свободная"
           }
